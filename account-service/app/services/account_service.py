...
class AccountService:
    ...
    def create_account(self, user_id, data: CreateAccountRequest):
    ...
    def get_account(self, account_id, user_id=None):
        ...
        if user_id and str(account.user_id) != str(user_id):
    ...
    def update_account(self, account_id, user_id, data: AccountUpdateRequest):
