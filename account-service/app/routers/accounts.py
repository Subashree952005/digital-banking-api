...
def create_account(
    ...
    return AccountService(db).create_account(payload["sub"], data)
...
def list_accounts(
    ...
    return AccountService(db).get_user_accounts(payload["sub"])
...
def get_account(
    ...
    return AccountService(db).get_account(account_id, payload["sub"])
...
def update_account(
    ...
    return AccountService(db).update_account(account_id, payload["sub"], data)
