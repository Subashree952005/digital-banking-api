...
SQLALCHEMY_TEST_URL = "sqlite:///./test_loan.db"
...
MOCK_OFFICER = {"sub": TEST_OFFICER_ID, "role": "officer"}
...
def officer_token(client):
    from app.core.dependencies import get_current_user, get_current_officer
    app.dependency_overrides[get_current_user] = lambda: MOCK_OFFICER
    app.dependency_overrides[get_current_officer] = lambda: MOCK_OFFICER
    yield "mock-token"
